<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AllDetail.aspx.cs" Inherits="Detail" %>
            ...
            <tr bgcolor="#BFDFFF" align="left">
                <td colspan="4">
                    <asp:GridView CssClass="brk1" ID="Advise" Width="100%" runat="server" BorderColor="#8EC7FF" OnRowCreated="GridView1_RowCreated" BorderStyle="Double" ShowHeader="false">
                        <Columns>
                            <asp:BoundField HeaderText="序号" ItemStyle-Width="35">
                                <HeaderStyle Height="24px" />
                                <ItemStyle Font-Size="18px" Height="24px" HorizontalAlign="Center" VerticalAlign="Middle"/>
                            </asp:BoundField>
                        </Columns>
                    </asp:GridView>
                </td>
